...
<div style={{ minHeight: "100vh",  backgroundImage: "url(" + require("assets/img/gamificafondo3.png") + ")"}}>
      ...
      <div className="section-buttons" style={{padding: "0 !important", color: 'black'}}>
        <Container>
        <div style={{textAlign: "center", padding: "60px 0 40px 0"}}>
            <h2 style={{marginTop: 60}}>¿CÓMO PUEDO CONSEGUIR RECOMPENSAS?</h2>
          </div>
          ...
          <iframe 
            ...
            src="https://view.genial.ly/6475b46a03afbe001754ee26"
            type="text/html"
